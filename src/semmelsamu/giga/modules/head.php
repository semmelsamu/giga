...
<?php if($content["nav"]) echo '<link rel="stylesheet" href="'.$content["path"].'css/nav.css">'; ?>
<?php if($content["header"]) echo '<link rel="stylesheet" href="'.$content["path"].'css/header.css">'; ?>
<?php if($content["content"]) echo '<link rel="stylesheet" href="'.$content["path"].'css/content.css">'; ?>
<?php if($content["aside"]) echo '<link rel="stylesheet" href="'.$content["path"].'css/aside.css">'; ?>
<?php if($content["footer"]) echo '<link rel="stylesheet" href="'.$content["path"].'css/footer.css">'; ?>
